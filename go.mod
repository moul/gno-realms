...
replace (
	github.com/gnolang/gno => github.com/allinbits/gno v0.0.0-20260615141933-0e6d7baffc7f
	github.com/gnolang/gno/contribs/gnodev => github.com/allinbits/gno/contribs/gnodev v0.0.0-20260615141933-0e6d7baffc7f
)
